    ...
    constitutionalReferences: [
      {
        ...
        relevance:
          "Enables protective legislation for women's economic rights in marriage dissolution",
      },
      {
        article: "Article 21",
        description: "Right to life and personal liberty",
        relevance:
          "Includes right to live with dignity, ensuring adequate maintenance after divorce",
      },
      {
        article: "Article 14",
        description: "Right to equality before law",
        relevance:
          "Ensures fair treatment in alimony proceedings regardless of gender",
      },
      {
        ...
        relevance:
          "Supports the principle that divorced spouses should have means to maintain reasonable living standards",
      },
    ],
    statutoryBasis: [
    ...
    constitutionalReferences: [
      {
        ...
        description: "Right to life and personal liberty",
        relevance:
          "Protects against unlawful detention while allowing lawful citizen arrests",
      },
      {
        article: "Article 19(1)(d)",
        description: "Right to move freely throughout India",
        relevance:
          "Citizen arrest must not violate fundamental right to movement",
      },
      {
        article: "Article 22(1)",
        description: "Protection against arrest and detention in certain cases",
        relevance:
          "Right to be informed of grounds of arrest applies even in citizen arrests",
      },
      {
        article: "Article 22(2)",
        description: "Right to consult and defend by legal practitioner",
        relevance:
          "Person arrested by citizen retains right to legal representation",
      },
    ],
    statutoryBasis: [
    ...
    constitutionalReferences: [
      {
        ...
        description: "Right to life and personal liberty",
        relevance:
          "Includes right to fair procedure and due process in all legal proceedings",
      },
      {
        article: "Article 14",
        description: "Right to equality before law",
        relevance:
          "Ensures equal treatment in legal procedures regardless of status",
      },
      {
        article: "Article 22",
      ...
      },
      {
        ...
        relevance:
          "Provides direct access to Supreme Court when constitutional rights are violated",
      },
      {
        article: "Article 136",
    ...
    constitutionalReferences: [
      {
        ...
        relevance:
          "Includes right to choose and change one's name as part of personal identity",
      },
      {
        article: "Article 21",
        description: "Right to life and personal liberty",
        relevance:
          "Right to personal identity and dignity includes right to choose one's name",
      },
      {
        article: "Article 25",
    ...
    constitutionalReferences: [
      {
        ...
        description: "Right to freedom of speech and expression",
        relevance:
          "Includes right to information and access to public documents",
      },
      {
        article: "Article 21",
        description: "Right to life and personal liberty",
        relevance:
          "Right to livelihood includes right to obtain necessary documents",
      },
      {
        article: "Article 14",
        description: "Right to equality before law",
        relevance:
          "Ensures non-discriminatory access to government services and documentation",
      },
      {
        part: "Part IV - Directive Principles",
        article: "Article 47",
        ...
        relevance:
          "State duty to ensure efficient public services including documentation",
      },
    ],
    statutoryBasis: [
    ...
    constitutionalReferences: [
      {
        ...
        description: "Right to constitutional remedies",
        relevance:
          "Fundamental right to approach courts for enforcement of constitutional rights",
      },
      {
        article: "Article 226",
        description: "Power of High Courts to issue writs",
        relevance:
          "High Court's power to issue writs for enforcement of rights",
      },
      {
        article: "Article 136",
      ...
      },
      {
        ...
        relevance:
          "Constitutional mandate for access to justice regardless of economic capacity",
      },
    ],
    statutoryBasis: [
  ...
  property: {
    constitutionalReferences: [
      ...
      },
      {
        article: "Article 31",
        description:
          "Former property rights provision (now repealed but principles remain)",
        relevance:
          "Historical basis for property protection, now governed by Article 300A",
      },
      {
        article: "Article 19(1)(f)",
        description: "Former right to acquire property (now omitted)",
        relevance:
          "Property acquisition now regulated through Article 300A and statutes",
      },
    ],
    statutoryBasis: [
      "Registration Act, 1908",
...
export function getConstitutionalReferences(
  topic: string,
  ...
  if (
    normalizedTopic.includes("alimony") ||
    normalizedTopic.includes("maintenance") ||
    normalizedTopic.includes("spousal support")
  ) {
    return CONSTITUTIONAL_LAW_REFERENCES.alimony.constitutionalReferences;
  }

  if (
    normalizedTopic.includes("citizen") &&
    normalizedTopic.includes("arrest")
  ) {
    return CONSTITUTIONAL_LAW_REFERENCES.citizenArrest.constitutionalReferences;
  }

  if (
    normalizedTopic.includes("legal procedure") ||
    normalizedTopic.includes("due process") ||
    normalizedTopic.includes("court process")
  ) {
    return CONSTITUTIONAL_LAW_REFERENCES.legalProcedures
      .constitutionalReferences;
  }

  if (
    normalizedTopic.includes("name change") ||
    normalizedTopic.includes("change name")
  ) {
    return CONSTITUTIONAL_LAW_REFERENCES.nameChange.constitutionalReferences;
  }

  if (
    normalizedTopic.includes("paperwork") ||
    normalizedTopic.includes("documents") ||
    normalizedTopic.includes("documentation")
  ) {
    return CONSTITUTIONAL_LAW_REFERENCES.paperwork.constitutionalReferences;
  }

  if (
    normalizedTopic.includes("court") ||
    normalizedTopic.includes("trial") ||
    normalizedTopic.includes("hearing")
  ) {
    return CONSTITUTIONAL_LAW_REFERENCES.courtProcedures
      .constitutionalReferences;
  }

  if (
    normalizedTopic.includes("property") ||
    normalizedTopic.includes("ownership") ||
    normalizedTopic.includes("land")
  ) {
...
export function formatConstitutionalReferences(
