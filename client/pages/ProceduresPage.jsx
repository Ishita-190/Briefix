...
export default function ProceduresPage() {
  ...
  const getCompletionPercentage = (procedure) => {
                ...
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <Badge variant={getComplexityVariant(procedure.complexity)}>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Badge variant={getComplexityVariant(selectedProcedure.complexity)}>
